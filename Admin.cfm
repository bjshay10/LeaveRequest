...
<cfelseif StepNum eq 10>
    ...
    <cfquery name="GetRequests" datasource="mesa_web">
        ...
        WHERE	Approved IS NULL and yearofrequest = '2026-2027'
...
<cfelseif StepNum eq 11>
    ...
    <cfquery name="GetDaysApp" datasource="mesa_web">
        ...
        FROM	LeaveReq_tblRequest
        WHERE	userid = '#Session.userid#' and yearofrequest = '2026-2027' and Approved = 'A'
    </cfquery>
    <table border="1" width="100%">
    	<tr>
...
<cfloop from="#Start#" to="#End#" index="a">
    ...
    <cfquery name="GetAppRequests" datasource="mesa_web">
    	SELECT	*
        FROM	LeaveReq_tblRequest
        WHERE	Approved = 'A' and yearofrequest = '2026-2027'  and EmpType = #a#
    ...
    <cfquery name="GetApproved" dbtype="query" timeout="600">
        ...
        WHERE	GetAppRequests.UserID = GetID.Username AND yearofrequest = '2026-2027'
    ...
    <cfquery name="GetPenRequests" datasource="mesa_web">
    	SELECT	*
        FROM	LeaveReq_tblRequest
        WHERE	Approved = 'P' and yearofrequest = '2026-2027' and EmpType = #a#
    </cfquery>
    ...
    <cfquery name="GetPending" dbtype="query">
        ...
        WHERE	GetPenRequests.UserID = GetID.Username AND yearofrequest = '2026-2027'
    ...
    <cfquery name="GetDenRequests" datasource="mesa_web">
    	SELECT	*
        FROM	LeaveReq_tblRequest
        WHERE	Approved = 'D' and yearofrequest = '2026-2027' and EmpType = #a#
    </cfquery>
    ...
    <cfquery name="GetDenied" dbtype="query" timeout="600">
        ...
        WHERE	GetDenRequests.UserID = GetID.Username and yearofrequest = '2026-2027'
