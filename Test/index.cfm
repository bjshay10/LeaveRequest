...
<cfelseif StepNum eq 3>
    ...
    <cfquery name="GetRequests" datasource="mesa_web">
        ...
        WHERE	userid = '#Session.Username#' and yearofrequest = '2017-2018'
                ...
                <tr>
                	<td colspan="2">
                        ...
                        <cfif #Session.LeaveType# eq 9>
                        	...
                        	Day Leave: <em>This leave may not be used for vacation or job interviews.  Must provide comments to HR if taking 3 or more consecutive days or a blackout day*</em><br />
                        <cfelse>
            ...
            <cfelseif Session.EmpType eq 2>
                ...
                <tr>
                    ...
                    <td colspan="2">
                        ...
                        <cfinput type="radio" name="LeaveType" value="6" required="yes" message="You must select a type of leave"><strong>Leave without Pay</strong><br />                        <br />
                    </td>
                    <td colspan="2">
                    	<p>
                ...
                <tr>
                    ...
                    <strong>(YEAR-ROUND EMPLOYEES ONLY)</strong></td>
                    <td colspan="2">
                   	...
                   	&nbsp;&nbsp;&nbsp;&nbsp;<em>(Documentation required)</em></td>
                </tr>
                <cfelse>
                <tr>
                    <td colspan="4">Check Leave Type You Are Requesting:</td>
...
<cfelseif StepNum eq 997>
    ...
    <cfset Session.yearofrequest = '2017-2018'>
